...
export const projects = [
  {
    title: "MINIMAL",
    description: "A premium luxury e-commerce store with curated fashion essentials. Features product browsing, cart management, secure checkout, and a sleek dark-themed UI with gold accents.",
    image: "/minimal.PNG",
    tags: ["Next.js", "Tailwind", "MongoDB", "Cloudinary"],
    liveUrl: "https://minimal-store-one.vercel.app/",
  },
  {
    title: "Oveniaa",
    description: "A full-featured food delivery platform for a restaurant in Faisalabad. Includes a dynamic menu, deals system, cart & ordering, and a bold modern dark UI with real-time delivery tracking.",
    image: "/oveniaa.PNG",
    tags: ["Next.js", "Tailwind", "MongoDB", "Node.js"],
    liveUrl: "https://ovenia.vercel.app/",
  },
];
